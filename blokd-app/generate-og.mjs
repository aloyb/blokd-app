...
<svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="600" y="90" font-size="72" font-weight="bold" fill="white" text-anchor="middle" font-family="Arial">BLOK D</text>
  <text x="600" y="140" font-size="28" fill="#888888" text-anchor="middle" font-family="Arial">Iuran Bulanan Tahun 2026</text>
  ...
  <text x="1000" y="350" font-size="28" fill="#4ecca3" font-weight="bold" text-anchor="end" font-family="Arial">Rp 6.660.000</text>
  
  <rect x="80" y="410" width="1040" height="90" rx="12" fill="#16213e" stroke="#4ecca3" stroke-width="3"/>
  <text x="120" y="460" font-size="28" fill="#ffffff" font-family="Arial">👤 Dipegang Bendahara</text>
  <text x="1000" y="460" font-size="28" fill="#ffffff" font-weight="bold" text-anchor="end" font-family="Arial">Rp 0</text>
