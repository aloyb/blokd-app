...
<svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="1000" y="240" font-size="28" fill="#e94560" font-weight="bold" text-anchor="end" font-family="Arial">Rp 270.000</text>
  ...
  <text x="1000" y="350" font-size="28" fill="#4ecca3" font-weight="bold" text-anchor="end" font-family="Arial">Rp 53.800</text>
  ...
  <text x="1000" y="460" font-size="28" fill="#ffffff" font-weight="bold" text-anchor="end" font-family="Arial">Rp 12.300</text>
