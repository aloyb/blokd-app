...
const styles = {
  ...
  statsGrid: { display: 'flex', flexDirection: 'column', gap: '2px', marginBottom: '15px', background: 'rgba(128,128,128,0.15)', borderRadius: '12px', padding: '5px', border: '1px solid rgba(128,128,128,0.3)' },
  statCard: { background: 'transparent', border: 'none', borderBottom: '1px solid rgba(128,128,128,0.5)', padding: '12px 10px', textAlign: 'center' },
  statCardWarning: { background: 'transparent', border: 'none', borderBottom: '1px solid rgba(128,128,128,0.5)' },
  ...
  historySection: { marginTop: '20px', padding: '15px', background: 'rgba(77,124,229,0.1)', border: '1px solid rgba(77,124,229,0.3)', borderRadius: '12px' },
  historyItem: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0', borderBottom: '1px solid rgba(77,124,229,0.3)', textAlign: 'center' },
