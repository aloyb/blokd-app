...
const styles = {
  ...
  statsGrid: { display: 'flex', flexDirection: 'column', gap: '2px', marginBottom: '15px', background: 'rgba(77,124,229,0.1)', borderRadius: '12px', padding: '5px', border: '1px solid rgba(128,128,128,0.3)' },
  statCard: { background: 'rgba(77,124,229,0.1)', border: 'none', borderBottom: '1px solid rgba(128,128,128,0.5)', padding: '12px 10px', textAlign: 'center' },
  statCardWarning: { background: 'rgba(77,124,229,0.1)', border: 'none', borderBottom: '1px solid rgba(128,128,128,0.5)' },
  lastStatCard: { background: 'rgba(77,124,229,0.1)', border: 'none', padding: '12px 10px', textAlign: 'center' },
  ...
  historySection: { marginTop: '20px', padding: '15px', background: 'rgba(77,124,229,0.1)', border: '1px solid rgba(128,128,128,0.3)', borderRadius: '12px' },
